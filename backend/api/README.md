...
For those with skill issues:

Auth/Databse api: [Ntex web framework](https://ntex.rs/docs/getting-started)

Proxy service: [HTML/JS](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide)

Postgres database: [PSQL](https://www.postgresqltutorial.com/)
